...
## Universal Mechanics
- Level: Everything has a Level. Outgoing damage is multiplied by `ATK/1000`, then raised to the power of a random value between 1 and `(AIM/1000)`. Health and armor essences are multiplied by `END/1000`.
...
- Demons drop bits of Health and Armor Essence on kill, which go into your Techno-Flask! Health and Armor essence gradually converts into health and armor over time. Health and Armor bonuses are replaced with various kinds of Essence Containers, which go right into your Technoflask. Your Technoflask also automatically refills at the start of each level, up to 50% of its capacity. Finally, you can press +USER1 to panic-drink your flask, dumping all of its current contents right away as overhealing and over-armor.
- 10000 units of essence turns into 100 health/armor at base stats. However, your Technoflask can keep building up essence after it hits max charges. If you get 10000 units of any essence while the flask is at max charge, you *upgrade* your flask's charge cap! With the Upgrade Mania Pack, you can also find flask upgrades in the wild, as well as health and armor upgrades.
...
- Double Barrel (Medium-Rare): The great communicator. Fires 21 pellets that do 7-15 damage despite firing only two shells. Altfire magically turns the shells into Dragon's Breath shells by consuming twice as many at once, throwing a spray of ripping fire projectiles that die out after a second or two. Dropped by the Super Shotgun Zombie, which comes with the Boomstick Pack.
...
- BFG 10K (Well Done): Not the classic you're used to. Consumes 5 cells per shot to rapid-fire 128-splash-damage shots. Altfire shoots a massive ripping Beam Attack that consumes cells extremely rapidly and melts most targets. Also drops from certain Spider Mastermind variants if you've unlocked the Boss Rush Pack.
